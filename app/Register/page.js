      ...
      <div className='w-96 p-8 bg-white border rounded-lg shadow-lg'>
        ...
        <form action='/api/register' method='post'>
          ...
          <div className='text-center'>
            <button type='submit' className='bg-green-500 text-white py-3 px-6 rounded-full hover:bg-green-600 transition duration-300 ease-in-out transform hover:scale-105'>
              Register
            </button>
          </div>
        </form>
